...
echo "Start Service get_gripper_status_service"
...
echo "Start Service: actuate_gripper_service"
rosrun robot_control actuate_gripper_service.py &

echo "Start Service: get_robot_is_moving_service"
rosrun robot_control get_robot_is_moving_service.py &
